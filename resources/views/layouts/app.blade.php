...
<body class="container mx-auto mt-10 mb-10 max-w-lg">
    ...
    <div x-data="{ flash: true }">
        {{-- controls whether our flash message should be visible or not --}}
        {{-- has() lets you check if certain variables exist inside the session --}}
        @if (session()->has('success'))
            <div x-show="flash"
                class="relative mb-10 rounded border border-green-400 bg-green px-4 py-3 text-lg text-green-700"
                role="alert">
